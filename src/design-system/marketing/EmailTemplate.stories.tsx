      ...
      <>
        <EmailSection>
          ...
          <p style={{ margin: '0 0 16px 0' }}>
            Welcome to Berget AI! We're excited to have you on board. Your account has been
            successfully created and you're ready to start deploying AI models on European
            infrastructure.
          </p>
        </EmailSection>
        ...
        <EmailSection>
          ...
          <ul style={{ margin: '0 0 16px 0', paddingLeft: '20px' }}>
            ...
            <li style={{ marginBottom: '8px' }}>Explore our model marketplace</li>
  ...
  args: {
    ...
    children: (
      <>
        <EmailSection>
          <p style={{ margin: '0 0 16px 0' }}>
            We received a request to reset your password for your Berget AI account.
          </p>
          <p style={{ margin: '0 0 16px 0' }}>
      ...
      <>
        ...
        <EmailSection>
          ...
          >
            ...
            <p style={{ margin: '0 0 16px 0', color: 'rgba(255, 255, 255, 0.8)' }}>
              We've added support for GPT-4 Turbo with 128K context windows. Deploy and scale
              with European data residency.
            </p>
            <a
              href="https://blog.berget.ai/gpt-4-turbo"
              style={{ color: '#60a580', textDecoration: 'none', fontSize: '14px' }}
            >
              Learn more →
            </a>
          </div>
        ...
        <EmailSection>
          ...
          >
            ...
            <p style={{ margin: '0 0 16px 0', color: 'rgba(255, 255, 255, 0.8)' }}>
              Get deeper insights into your AI usage with our new analytics dashboard. Track
              costs, performance, and usage patterns.
            </p>
            <a
        ...
        <EmailSection>
          <p style={{ margin: 0, fontSize: '13px', color: 'rgba(255, 255, 255, 0.5)' }}>
            You're receiving this because you're subscribed to Berget AI updates.{' '}
            <a
  ...
  args: {
    ...
    children: (
      <>
        ...
        <EmailSection>
          <p style={{ margin: 0, fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)' }}>
            This link will expire in 48 hours. If you didn't create an account, you can safely
            ignore this email.
          </p>
        </EmailSection>
      </>
    ...
    children: (
      <>
        <EmailSection>
          ...
          <p style={{ margin: '0 0 16px 0' }}>Hi there,</p>
          <p style={{ margin: '0 0 16px 0' }}>
            We'll be performing scheduled maintenance on our infrastructure to improve performance
            and stability.
          </p>
        </EmailSection>
        ...
        <EmailSection>
          <p style={{ margin: '0 0 16px 0' }}>
            During this time, you may experience brief service interruptions. All services will be
            fully restored by 04:00 CET.
          </p>
          <p style={{ margin: 0, fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)' }}>
