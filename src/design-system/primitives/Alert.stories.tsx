...
export const DescriptionOnly: Story = {
  render: () => (
    <Alert variant="warning" className="w-[400px]">
      <AlertDescription>
        Your trial period ends in 3 days. Upgrade now to continue using all features.
      </AlertDescription>
    </Alert>
  ),
}
  ...
  render: () => (
    <div className="space-y-4 w-[500px]">
      ...
      <Alert variant="warning">
        ...
        <AlertDescription>
          We are experiencing slower than normal response times. Our team is investigating.
        </AlertDescription>
      </Alert>
      ...
      <Alert variant="destructive">
        ...
        <AlertDescription>
          The API service is currently unavailable. We are working to restore service.
  ...
  render: () => (
    <div className="space-y-4 w-[500px]">
      ...
      <Alert variant="destructive">
        ...
        <AlertDescription>
          Unable to deploy model due to insufficient GPU resources. 
...
export const FeatureAnnouncements: Story = {
  render: () => (
    <Alert variant="info" className="w-[500px]">
      ...
      <AlertDescription>
        We have added support for GPT-4 Turbo with 128K context windows. 
        Try it now in your deployments!
      </AlertDescription>
    </Alert>
  ),
}
