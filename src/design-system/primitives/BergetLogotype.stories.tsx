...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: `
The Berget AI logotype with text.
...
- Maintain clear space around logotype
- Do not distort or modify the logotype shape
        `
            }
        }
    },
...
} satisfies Meta<typeof BergetLogotype>;
...
/**
 * Small size (24px) - For compact headers
 */
...
export const SizeComparison: Story = {
    render: () => (
        <div className="flex items-end gap-8">
            ...
            <div className="text-center">
                <BergetLogotype size={64} variant="light" />
    ...
    render: () => (
        <div className="min-h-screen flex items-center justify-center bg-background p-8">
            <div className="text-center space-y-8 max-w-3xl">
                <BergetLogotype size={120} variant="light" />
                <h1 className="text-5xl font-serif font-medium">
                    European AI Infrastructure
                </h1>
                <p className="text-xl text-muted-foreground">
                    Deploy and scale AI models with data residency in Europe. GDPR
                    compliant, sovereign, and powerful.
                </p>
    ...
    render: () => (
        <div className="grid grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg">
                ...
                <BergetLogotype size={64} variant="dark" />
            </div>
        </div>
    )
};
