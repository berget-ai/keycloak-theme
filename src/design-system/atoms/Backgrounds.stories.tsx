...
5. **Grainy Gradient** - Artistic grainy gradient with colored ellipses
        ...
        <div className="min-h-screen bg-[hsl(var(--background))] flex items-center justify-center">
            <div className="text-center max-w-2xl px-6">
                ...
                <p className="text-[hsl(var(--muted-foreground))] mb-8">
                    Pure deep black background (#0A0A0A) for focused, distraction-free
    ...
    render: () => (
        <GridBackground className="bg-[hsl(var(--background))] flex items-center justify-center">
            <div className="text-center max-w-2xl px-6">
                ...
                <p className="text-[hsl(var(--muted-foreground))] mb-8">
                    Subtle 24×24px grid with 2% opacity. Adds technical structure while
    ...
    render: () => (
        ...
        >
            <div className="text-center max-w-2xl px-6">
                ...
                <p className="text-[hsl(var(--muted-foreground))] mb-8">
                    Same grid but with 5% opacity - more visible structure. Use sparingly,
                    primarily for design-focused contexts.
                </p>
            </div>
        </GridBackground>
    )
        ...
        <div className="relative min-h-screen bg-background flex items-center justify-center">
            ...
            <div className="relative z-10 text-center max-w-2xl px-6">
                ...
                <p className="text-white/80 text-lg mb-8">
                    ...
                    for tech/SaaS platforms, enterprise products, and conveying
                    connectivity.
                </p>
 ...
 *
 * Artistic grainy gradient with colored ellipses and blur overlay.
...
/**
 * Pattern Background - Default (48px)
 *
...
/**
 * Pattern Background - Compact (32px)
 *
...
export const PatternCompact: StoryObj = {
    ...
    render: () => (
        ...
        >
            <div className="text-center max-w-2xl px-6">
                <h1 className="text-5xl mb-4 text-white">Pattern Background (Compact)</h1>
                <p className="text-white/90 text-lg mb-8">
