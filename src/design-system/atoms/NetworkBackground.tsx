 ...
 *
 * Animated network of connected nodes that creates a tech/enterprise aesthetic.
 * Nodes float slowly and particles travel along connections.
 *
 * **Use Cases:**
 * - Tech/SaaS hero sections
 ...
 * - Modern/tech brand identity
 * - B2B/Enterprise contexts
 * - Infrastructure/platform products
 *
 * **Combines Well With:**
 * - GradientBackground (layer on top)
 * - Hero sections
